...
export const validEmail = function (inputEmail) {
  ...
  let emailRegExp = new RegExp(emailRegex);
  ...
  if (testEmail) {
    ...
    message.innerText = "l'email  saisi n'est pas valide";
...
export const validfirstName = function (inputfirstName) {
  let firstNameRegExp = new RegExp(textRegex);
  ...
  if (testfisrtName) {
    ...
    message.innerText = "le prénom saisi n'est pas valide";
    return false;
  }
};
...
export const validlastName = function (inputlastName) {
  let lastNameRegExp = new RegExp(textRegex);
  ...
  if (testlastName) {
    ...
    message.innerText = "le nom saisi n'est pas valide";
    return false;
  }
};
...
export const validaddress = function (inputAddress) {
  let addressRegExp = new RegExp(addressRegex);
  ...
  if (address) {
    ...
    message.innerText = "l'addresse saisie n'est pas valide";
    return false;
  }
};
...
export const validcity = function (inputCity) {
  let cityRegExp = new RegExp(textRegex);
  ...
  if (city) {
    ...
    message.innerText = "le nom de ville saisi n'est pas valide";
    return false;
  }
};
